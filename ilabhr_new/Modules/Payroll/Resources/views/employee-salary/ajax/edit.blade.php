                            ...
                            <div class="col-md-4">
                                <x-forms.input-group class="mt-2">
                                    ...
                                    <input type="number" class="form-control height-35 f-14" name="annual_salary"
                                           onkeyup="changeClc()"
                                           id="annual_salary" value="{{ $employeeMonthlySalary->annual_salary }}">
                                </x-forms.input-group>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <x-forms.input-group>
                                            <input type="number" value="{{ $employeeMonthlySalary->basic_salary }}" onmouseout="changeClc()" name="basic_salary" id="basic_value"
                                    ...
                                    @else
                                        @php
                                            $basicSalary = ($employeeMonthlySalary->annual_salary / 12) / 100 * $employeeMonthlySalary->basic_salary;
                                        @endphp
                                        <div class="col-md-3">
                                            <x-forms.input-group>
                                                <x-slot name="prepend" id="currency">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    @elseif($value->component->value_type == 'percent')
                                                        <x-forms.input-group>
                                                            ...
                                                            <input type="text" class="form-control height-35 f-14" name="slack_username"
                                                                id="slack_username"
                                                                value="{{ $payrollController->currencyFormatterCustom(($employeeMonthlySalary->annual_salary / 12 / 100) * $value->component->component_value * 12) }}"
                                                                readonly>
                                                        </x-forms.input-group>
                                                    @elseif($value->component->value_type == 'basic_percent')
                                                        <x-forms.input-group>
                            ...
                            <div class="col-md-12 salary-total mt-2 rounded bg-light">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <h3 class="heading-h3 mb-0 py-4">
                                             {{ currency_format($employeeMonthlySalary->annual_salary / 12, ($currency->currency ? $currency->currency->id : company()->currency->id )) }}</h4>
                                    </div>
                                    <div class="col-md-3">
                                        <h3 class="heading-h3 mb-0 py-4">
                                            {{ currency_format($employeeMonthlySalary->annual_salary, ($currency->currency ? $currency->currency->id : company()->currency->id )) }}</h4>
                                    </div>
                                </div>
...
<script>
    lastValue = 0;
    yearlySalary = {{ $employeeMonthlySalary->annual_salary }}
