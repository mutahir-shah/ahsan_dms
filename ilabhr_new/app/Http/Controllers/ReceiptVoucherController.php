...
class ReceiptVoucherController extends AccountBaseController
{
    ...
    public function demoPdf($id)
    {
        try {
            ...
            // return $file_name;
            $html = view('receipt-voucher.pdf.demo_pdf',$this->data)->toArabicHTML();
            ...
            // return view('receipt-voucher.pdf.demo_pdf');
            $pdf            = Pdf::loadView('receipt-voucher.pdf.demo_pdf', $this->data);
            return $pdf->stream();
        } catch (\Exception $e) {
