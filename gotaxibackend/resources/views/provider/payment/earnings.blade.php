                        ...
                        <div class="earning-acc pad20">
                            ...
                            <div class="row no-margin">
                                <div class="pull-left trip-left">
                                    <h3 data-toggle="collapse" data-target="#demo1"
                                        class="accordion-toggle collapsed acc-tit">
                                ...
                                <table class="table table-condensed table-responsive" style="border-collapse:collapse;">
                                    ...
                                    @foreach($weekly as $day)
                                        <tr>
                                            <td>
                                                @if($day->created_at)
                                                    {{date('Y-m-d',strtotime($day->created_at))}}
                                                    - {{$day->created_at->diffForHumans()}}
                                                @else
                                                    -
                                                @endif
                                            </td>
                        ...
                        <table class="earning-table table table-responsive">
                            ...
                            @foreach($fully as $each)
                                <tr>
                                    ...
                                    <td>{{$each->status}}</td>
                                    <td>{{$each->distance}} @if (Setting::get('distance_system') === 'metric')
                                            KM
                                        @else
                                            Miles
                                        @endif s
                                    ...
                                    <td>
                                        ...
                                        <?php   
                                            $fully_sum += $each->cancel_amount_driver;
                                        ?>
                                        {{currency($each_sum)}}
                                        @endif

                                        @if($each->status != 'CANCELLED' && $each->payment != "")
                                                <?php $each_sum = 0;
