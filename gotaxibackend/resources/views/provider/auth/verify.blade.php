...
@section('content')
    <div class="pro-dashboard-head">
        <div class="container">
            <a href="#" class="pro-head-link active">Verify Now</a>
        </div>
    </div>
            ...
            <div class="dash-content">
                ...
                <div class="row no-margin">
                    @if (Setting::get('twilio_verification', 0) == 1)
                        <form action="{{ url('provider/verifyProviderOTP') }}" method="POST">
                            @csrf
                            <div class="input-group dash-form" style="margin-top: 15px;">

                                <input type="text" class="form-control" id="origin-input" name="otp"
                    ...
                    @elseif(Setting::get('verification', 0) == 1)
                        <div class="input-group dash-form" style="margin-top: 15px;">
                            ...
                            <input type="hidden" id="phone-number" name="phone-number" value="{{ $provider->mobile }}"/>
