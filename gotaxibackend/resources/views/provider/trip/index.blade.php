                                        ...
                                        <div class="col-md-6">
                                            <div class="my-trip-left">
                                                ...
                                                <div class="from-to row no-margin">
                                                    <div class="from">
                                                        <h5>FROM</h5>
                                                        <h6>{{ $Job->started_at != null ? $Job->started_at : 'N/A' }}</h6>
                                                        <p>{{ $Job->s_address }}</p>
                                                    </div>
                                                    <div class="to">
                                                        <h5>TO</h5>
                                                        <h6>{{ $Job->finished_at != null ? $Job->finished_at : 'N/A' }}</h6>
                                                        <p>{{ $Job->d_address }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mytrip-right">
                                                ...
                                                <div class="fare-break">
                                                    ...
                                                    <h5>Base Fare
                                                        <span>{{ $Job->payment ? $Job->payment->base_price : 'N/A' }}</span>
                                                    </h5>
                                                    <h5><strong>Time Based
                                                            Fare </strong><span><strong>{{ $Job->payment ? $Job->payment->time_price : 'N/A' }}</strong></span>
                                                    </h5>
                                                    <h5 class="big">
                                                        <strong>TOTAL </strong><span><strong>{{ $Job->payment ? $Job->payment->total : 'N/A' }}</strong></span>
                                                    </h5>
                                                    ...
                                                    <div class="trip-user">
                                                        <div class="rating-outer">
                                                            <input type="hidden" class="rating"
                                                                   value="{{ $Job->rating->provider_rating }}"/>
                                                        </div>
