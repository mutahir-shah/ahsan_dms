    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="mb-1">Provider
                    Name: {{ $Document->provider->first_name }} {{ $Document->provider->last_name }}</h5>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <form action="{{ route('fleet.provider.document.update', [$Document->provider->id, $Document->id]) }}"
                              method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                    ...
                    <div class="col-xs-6">
                        <form action="{{ route('fleet.provider.document.destroy', [$Document->provider->id, $Document->id]) }}"
                              method="POST">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
