...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="card">
            ...
            <p class="text-center">{{ translateKeyword('fleet-panel')}}</p>
                    ...
                    <div class="input-group mb-3">
                        @if(Setting::get('show_preset_credentials') == 1)
                            <input type="email" class="form-control" name="email" required="true" id="email"
                                   placeholder="{{ translateKeyword('email')}}" value="vendor@meemcolart.com">
                        @else
                            <input type="email" class="form-control" name="email" required="true" id="email"
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="icheck-primary">
                                ...
                                <label for="remember">
                                    {{ translateKeyword('remember_me')}}
                                </label>
                            </div>
                        </div>
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" class="btn btn-primary btn-block">{{ translateKeyword('sign_in')}}</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
