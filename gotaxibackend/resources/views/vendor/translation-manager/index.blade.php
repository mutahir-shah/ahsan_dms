...
<div style="width: 80%; margin: auto;">
    ...
    <p>Warning, translations are not visible until they are exported back to the app/lang file, using publish
        button.</p>
    ...
    @if(Session::has('successPublish'))
        ...
        @if(!isset($group))
            ...
            <form role="form">
                ...
                <div class="form-group">
                    <select name="group" id="group" class="form-control group-select">
                        ...
                        <option value="<?= $key ?>"
                            <?= $key == $group ? ' selected' : '' ?><?= $value ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </form>
            ...
            <p>Choose a group to display the group translations. If no groups are visible, make sure you have run the
                migrations
                and imported the translations.</p>
