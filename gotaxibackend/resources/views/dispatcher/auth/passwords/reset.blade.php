            ...
            <div class="col-md-4 offset-md-4 px-3">
                <div class="box b-a-0">
                    ...
                    <form class="form-material mb-1" role="form" method="POST"
                          action="{{ url('/dispatcher/password/reset') }}">
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                            <input type="email" name="email" value="{{ $email or old('email') }}" autofocus
                                   required="true" class="form-control" id="email" placeholder="Email">
                            @if ($errors->has('email'))
                        ...
                        <div class="px-2 form-group mb-0">
                            <button type="submit" class="btn btn-purple btn-block text-uppercase">Reset Password
                            </button>
                        </div>
                    </form>
                </div>
