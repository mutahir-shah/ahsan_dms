    ...
    <nav class="navbar navbar-light">
        ...
        <div class="navbar-right navbar-toggleable-sm collapse" id="collapse-1">
            ...
            <ul class="nav navbar-nav">
                <li class="nav-item hidden-sm-down  {{ request()->is('dispatcher') ? 'active' : ''  }}">
                    <a href="{{ route('dispatcher.index') }}" class="nav-link">
                        <span class="s-text">Dispatcher Panel</span>
                    </a>
                </li>

                <li class="nav-item hidden-sm-down {{ request()->is('dispatcher/booking-requests') ? 'active' : ''  }}">
                    <a href="{{ route('dispatcher.booking-requests') }}" class="nav-link">
                        <span class="s-text">Booking Requests</span>
                    </a>
                </li>
