    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                <a href="{{route('account.openTicket','open')}}" class="btn btn-default pull-right"><i
                            class="fa fa-angle-left"></i> Back</a>

                <h5 style="margin-bottom: 2em;"><i class="ti-receipt"></i>&nbsp;Complaint Details</h5>
                <hr>

                <form class="form-horizontal" action="{{route('crm.transfer', $data->id )}}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-8">
                            <select class="form-control" name="transfer" id="transfer" required>
                                ...
                                <option value="1" {{($data->transfer == 1)?'selected':''}}>Customer Relationship
                                </option>
                                <option value="2" {{($data->transfer == 2)?'selected':''}}>Dispatcher Department
                                </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control" type="text" value="{{$data->reply}}" name="reply" required
                                   id="reply" placeholder="Reply">
                        </div>
                    </div>
                    <div class="form-group row">
