                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn shadow-box btn-success btn-rounded w-min-sm m-b-0-25 waves-effect waves-light"
                                        ...
                                        onclick="approve_popup({{$service->id}});">Details
                                </button>
                            </td>
                        </tr>
                    @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a type="button" id="ApprovedId" class="btn btn-primary text-white" onclick="ApprovedId();"><span
                                aria-hidden="true">Approve</a>
                </div>
            </div>
        </div>
    </div>
