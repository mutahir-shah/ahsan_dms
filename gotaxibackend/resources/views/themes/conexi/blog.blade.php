                ...
                <div class="col-xl-6 col-lg-12">
                    <div class="single-blog-style-one">
                        ...
                        <div class="text-block">
                            ...
                            <h3><a href="blog-details">We ensure you that your journey is comfortable and safe</a></h3>
                ...
                <div class="col-xl-6 col-lg-12">
                    <div class="single-blog-style-one">
                        ...
                        <div class="text-block">
                            ...
                            <h3><a href="blog-details">Car with private and discreet cabman for a service</a></h3>
                            <p>There are many variations of passages of lorem ipsum available but the majority have
                                suffered alteration...</p>
                        </div><!-- /.text-block -->
                    </div><!-- /.single-blog-style-one -->
                ...
                <div class="col-xl-6 col-lg-12">
                    <div class="single-blog-style-one">
                        ...
                        <div class="text-block">
                            ...
                            <h3><a href="blog-details">Tarvel in style on the one day that counts</a></h3>
                            <p>There are many variations of passages of lorem ipsum available but the majority have
                                suffered alteration...</p>
                        </div><!-- /.text-block -->
                    </div><!-- /.single-blog-style-one -->
                ...
                <div class="col-xl-6 col-lg-12">
                    <div class="single-blog-style-one">
                        ...
                        <div class="text-block">
                            ...
                            <h3><a href="blog-details">Learn how to get long distance travel in cheap rates</a></h3>
                            <p>There are many variations of passages of lorem ipsum available but the majority have
                                suffered alteration...</p>
                        </div><!-- /.text-block -->
                    </div><!-- /.single-blog-style-one -->
                ...
                <div class="col-xl-6 col-lg-12">
                    <div class="single-blog-style-one">
                        ...
                        <div class="text-block">
                            ...
                            <h3><a href="blog-details">Our first choice for airport transfers and corporate travel</a>
                            </h3>
                            <p>There are many variations of passages of lorem ipsum available but the majority have
                                suffered alteration...</p>
                        </div><!-- /.text-block -->
