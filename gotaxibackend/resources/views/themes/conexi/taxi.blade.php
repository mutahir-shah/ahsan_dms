                ...
                <div role="tabpanel" class="tab-pane show active  animated fadeInUp" id="hybrid">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="single-taxi-one">
                                <div class="inner-content">
                                    <img src="{{ asset('conexi/images/pricing/pricing-1-4.png') }}"
                                         alt="Awesome Image"/>
                                    <div class="icon-block">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="single-taxi-one">
                                <div class="inner-content">
                                    <img src="{{ asset('conexi/images/pricing/pricing-1-5.png') }}"
                                         alt="Awesome Image"/>
                                    <div class="icon-block">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="single-taxi-one">
                                <div class="inner-content">
                                    <img src="{{ asset('conexi/images/pricing/pricing-1-6.png') }}"
                                         alt="Awesome Image"/>
                                    <div class="icon-block">
