    ...
    <section class="inner-banner">
        <div class="container">
            <ul class="thm-breadcrumb">
                ...
                <li><span class="page-title">Book a Job</span></li>
            </ul><!-- /.thm-breadcrumb -->
            <h2>Book a Job</h2>
        </div><!-- /.container -->
                ...
                <div class="col-lg-8">
                    ...
                    <form action="inc/sendemail.php" class="booking-form-two ">
                        {{-- <p>There are many variations of passages of lorem ipsum available but the majority have suffered
                            alteration in some form by injected humor or random word which don't look even slightly believ-
                            <br>able you are going to use a passage.</p> --}}
