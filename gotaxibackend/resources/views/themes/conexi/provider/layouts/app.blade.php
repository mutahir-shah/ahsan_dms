...
<body>
    ...
    <div class="page-wrapper">
        @include('themes.conexi.provider.layouts.partials.header')
        @yield('content')
        @include('themes.conexi.provider.layouts.partials.footer')
    </div>
    <a href="#" data-target="html" class="scroll-to-target scroll-to-top"><i class="fa fa-angle-up"></i></a>
    <!-- /.scroll-to-top -->
    @include('themes.conexi.provider.layouts.partials.scripts')
</body>
<!--end::Body-->
