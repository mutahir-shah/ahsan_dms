        ...
        <div class="col-sm-9">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show  @if (Setting::get('email_field', 0) == 1) active @endif" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <form class="login-frm" role="form" method="POST" action="{{ url('/provider/login') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group mb-1 ">
                            ...
                            <div class="input-holder" id="show_hide_password">
                                <input type="password" name="password" id="password"
                                placeholder="{{ translateKeyword('password') }}"><a href="javascript:">
                ...
                <ul class="special-checkbox">
                    <li> <a class="text-dark small " href="{{ route('provider.register') }}">{{ translateKeyword('register') }}</a>
                    </li>
