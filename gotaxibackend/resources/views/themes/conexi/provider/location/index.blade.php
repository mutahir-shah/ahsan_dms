                        ...
                        <div class="manage-doc-section-content row">
                            <div class="prof-sub-col col-xs-12">
                                ...
                                <div class="form-group">
                                    <input tabindex="2" id="pac-input" class="form-control" type="text"
                                           placeholder="Enter a location" name="s_address">
                                </div>
                            </div>
                            ...
                            <form action="{{ route('provider.location.update') }}" id="location_update_form"
    ...
    <script>
        ...
        function initMap() {
            ...
            var userLocation = new google.maps.LatLng(
                    @if(Auth::guard('provider')->user()->latitude) {{ Auth::guard('provider')->user()->latitude }} @else 11
            .8508117 @endif,
                    @if(Auth::guard('provider')->user()->longitude) {{ Auth::guard('provider')->user()->longitude }} @else 79
            .7854668 @endif
            );
