        ...
        <div class="row one">
            ...
            <table width="100%">
                <tr class="three">
                    ...
                    {{-- @dd($order) --}}
                    <td align="left" style="width: 40%;vertical-align: top;">
                        <h3 style="margin-bottom: 5px;">Faktura nr. {{ $userRequest->booking_id }}</h3>
                        <p style="margin-bottom: 5px;">
                            Datum: {{ $userRequest->updated_at->toFormattedDateString() }}</p>
                        <p style="margin-bottom: 5px;">
                            Mottagare: {{ $userRequest->user->first_name . ' ' . $userRequest->user->last_name  }}</p>
                        @if (Setting::get('partner_company_info', 0) == 1)
                            <p style="margin-bottom: 5px;">Företag namn: {{ $userRequest->provider->company_name }}</p>
                            <p style="margin-bottom: 5px;">Företag
                                Adress: {{ $userRequest->provider->company_address }}</p>
                            <p style="margin-bottom: 5px;">Företag VAT: {{ $userRequest->provider->company_vat }}</p>
                        @endif
                    </td>
                </tr>
            </table>
            ...
            <table width="100%">
                <tr class="three">
                    <td align="left" style="width: 40%;vertical-align: top;">
                        <p style="margin-bottom: 5px;"><b>Ursprung:</b> {{ $userRequest->s_address }}
                            - {{ $userRequest->started_at->toDayDateTimeString() }}</p>
                        <p style="margin-bottom: 5px;"><b>Bestämmelseort:</b> {{ $userRequest->d_address }}
            ...
            <table width="100%" class="table-bordered">
                <tr class="three">
                    ...
                    <td align="left"><b>Grundpris</b></td>
                    <td align="left"><b>Beskatta {{ Setting::get('tax_percentage', 10) }}%</b></td>
                    <td align="left"><b>Totalsumma</b></td>
                </tr>
                <tr class="three">
                    ...
                    <tr class="three">
                        <td align="left" style="width: 60%; vertical-align: top;">
                            @if ($userRequest->tip_amount)
                                <p>Dricksbelopp: {{ currency($userRequest->tip_amount) }}</p>
                            @endif
                        </td>
                        <td align="left" style="vertical-align: top;">
                            @php
                                $card = Card::get()->first();
                            @endphp
                            <p>Debiteras med kort ****{{ $card->last_four }}</p>
                        </td>
                    </tr>
                </table>
