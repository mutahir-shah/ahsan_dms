        ...
        <div class="full-page-bg-inner">
            <div class="row no-margin">
                <div class="col-md-6 log-left">
                    <span class="login-logo" style="background:none"><a href="{{ route('website.login') }}"><img
                                    style="height:50px"
                                    src="{{ Setting::get('site_icon') }}"></a></span>
                    <h2>Create your account and get your desired service in minutes.</h2>
                    <p>Welcome to {{ Setting::get('site_title', '')  }}, the easiest way to order from a multitude
                        of services at the tap of a button.</p>
                </div>
                    ...
                    <div class="login-box-outer">
                        <div class="login-box row no-margin">
                            ...
                            <form role="form" method="POST" action="{{ url('/register') }}">
                                ...
                                <div id="first_step">
                                    <div class="col-md-4">
                                        <input value="+27" type="text" placeholder="+27" id="country_code"
                                               name="country_code"/>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="padding-bottom: 10px;" id="mobile_verfication">
                                        <input type="button" class="log-teal-btn small" onclick="smsLogin();"
                                               value="Next"/>
                                    </div>
