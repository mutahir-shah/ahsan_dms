    ...
    <div class="content-area py-1">
        ...
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <h5 style="margin-bottom: 2em;">{{ translateKeyword('update')}}</h5>
                ...
                <form class="form-horizontal" action="{{route('admin.package.update', $package->id )}}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            ...
                            <input class="form-control" type="text" value="{{ $package->name }}" name="name" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            ...
                            <input class="form-control" type="number" value="{{ $package->base_time }}" name="base_time"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            ...
                            <input class="form-control" type="number" value="{{ $package->base_distance }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            ...
                            <input class="form-control" type="number" value="{{ $package->base_price }}"
                                   name="base_price" required id="base_price" placeholder="Base Price">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            ...
                            <input class="form-control" type="number" value="{{ $package->after_time_price }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            ...
                            <input class="form-control" type="number" value="{{ $package->after_distance_price }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            ...
                            <a href="{{route('admin.package.index')}}" class="btn btn-danger btn-block">{{ translateKeyword('cancel')}}</a>

                        </div>

                        <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">

                            <button type="submit" class="btn btn-primary btn-block">{{ translateKeyword('Update Package')}}</button>
