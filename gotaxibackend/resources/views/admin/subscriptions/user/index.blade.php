                ...
                <div class="col-12">
                    <div class="card border-radius-10">
                        <div class="card-header">
                            <h5 class="mb-1">{{ translateKeyword('Rider Subscriptions') }}</h5>
                            @if ($add_permission == 1)
                            <a href="{{ route('admin.subscription-user.create') }}" style="margin-left: 1em;"
                        ...
                        <div class="card-body" style="overflow: scroll;">
                            ...
                            <table id="table-1" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th>{{ translateKeyword('add-new-subscription') }}</th>
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.subscription-user.edit', $subscription->id) }}"
                                               class="btn btn-info"><i class="fa fa-edit"></i> {{ translateKeyword('edit') }}</a>
                                            @endif
                                            
                                            <form action="{{ route('admin.subscription-user.destroy', $subscription->id) }}" method="POST">
                                                {{ csrf_field() }}
