    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white border-radius-10">
                <h5 class="mb-1"><span class="s-icon"><i class="ti-stats-up"></i></span> {{ translateKeyword('approved-withdraw-request') }}</h5>
                <hr/>
                <table class="table table-striped table-bordered dataTable" id="table-2" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <th>{{ translateKeyword('request-date') }}</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a type="button" id="ApprovedId" class="btn btn-primary " onclick="DisApprovedId();"><span
                                aria-hidden="true">{{ translateKeyword('disapproved') }}</a>
                </div>
            </div>
        </div>
    </div>
