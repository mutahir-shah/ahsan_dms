    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <div class="box box-block bg-white border-radius-10">
                ...
                <h5 style="margin-bottom: 2em;">{{ translateKeyword('add_account_manager') }}</h5>
                @include('common.notify')
                <form class="form-horizontal" action="{{route('admin.account-manager.store')}}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <button type="submit" class="btn btn-primary">{{translateKeyword('add_account_manager')}}</button>
