            ...
            <div class="col-sm-9 col-xs-9">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-tasks dropdown-menu dropdown-menu-right animated fadeInUp">
                                ...
                                <div class="t-item">
                                    ...
                                    <progress class="progress progress-success progress-sm" value="100" max="100">100%
                                    </progress>
               ...
               <img src="{{img($user->picture)}}" alt="">
                                        ...
                                        <div class="mi-text"><a class="text-black"
                                                                href="#">{{ucwords($user->first_name)}}</a> <span
                                                    class="text-muted">does sign up</span> <a class="text-black"
                                                                                              href="#"></a></div>
               ...
               <img src="{{img($provider->avatar)}}" alt="">
                                        ...
                                        <div class="mi-text"><a class="text-black"
                                                                href="#">{{ucwords($provider->first_name)}}</a> <span
                                                    class="text-muted">does sign up</span> <a class="text-black"
                                                                                              href="#"></a></div>
                     ...
                     @if(isset(Auth::guard('admin')->user()->picture))
                         ...
                         @endif
                           ...
                           document.getElementById('logout-form').submit();"><i class="ti-power-off mr-0-5"></i> Sign
                                    out</a>
                            </div>
                        </li>
                    </ul>
