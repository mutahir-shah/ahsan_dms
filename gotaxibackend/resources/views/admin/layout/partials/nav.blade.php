        ...
        <ul class="sidebar-menu">
            ...
            <li class="with-sub">
                ...
                <a href="#" class="waves-effect  waves-light">
                    ...
                    <span class="s-text">Provider</span>

                </a>

                <ul>

                    <li><a href="{{ route('admin.provider.index') }}">All Provider</a></li>

                    <li><a href="{{ route('admin.provider.create') }}">Add Provider</a></li>
            ...
            <li class="with-sub">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('admin.ride.statement') }}">Job Revenue</a></li>

                    <li><a href="{{ route('admin.payment','ride') }}">Job History</a></li>
            ...
            <span class="s-text">All Job</span>
            ...
            <li class="with-sub">
                ...
                <ul>
                    <li><a href="{{ route('admin.requests.index') }}">Ongoing Job</a></li>

                    <li><a href="{{ route('admin.requests.cancel') }}">Cancelled Job</a></li>
                    <li><a href="{{ route('admin.requests.completed') }}">Completed Job</a></li>
                </ul>
            </li>
            <li>
                ...
                <a href="{{ route('admin.requests.scheduled') }}" class="waves-effect  waves-light">
                    ...
                    <span class="s-text">Scheduled Job</span>
            ...
            <li class="with-sub">
                ...
                <a href="#" class="waves-effect  waves-light">
                    ...
                    <span class="s-text">Job Type</span>

                </a>

                <ul>

                    <li><a href="{{ route('admin.ridetype.index') }}">All Job Type</a></li>

                    <li><a href="{{ route('admin.ridetype.create') }}">Add Job type</a></li>
            ...
            <li class="with-sub">
                ...
                <ul>
                    ...
                    <!--<li><a href="{{ route('admin.referral.index') }}">Reward Rule</a></li>
               <li><a href="{{ route('admin.referral.index') }}">Reward Rule</a></li>-->
            ...
            <li class="with-sub">
                ...
                <a href="#" class="waves-effect  waves-light">
                    ...
                    <span class="s-text">Reward & Reward</span>
                ...
                <ul>
                    ...
                    <li><a href="{{ route('admin.referral.index') }}">Reward Rule</a></li>
                    <li><a href="{{ route('admin.referral.create') }}">Add Reward</a></li>
                    <li><a href="{{ route('admin.referral.index') }}">Reward Rule</a></li>
                    <li><a href="{{ route('admin.referral.create') }}">Add Reward</a></li>
