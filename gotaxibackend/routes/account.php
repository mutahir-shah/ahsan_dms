...
|--------------------------------------------------------------------------
*/
Route::group(['middleware' => 'AccountProtectOTP'], function(){
    Route::get('/otp', 'AccountController@opt')->name('otp');
    Route::post('/verify-otp', 'AccountController@verifyOpt')->name('verify-otp');
});
Route::group(['middleware' => 'AccountVerifiedOTP'], function(){
...
//Accounts
Route::get('/payment/mtn', 'MTNController@depositNow')->name('mtn.deposit');
...
Route::get('new_account', 'Resource\AccountBankResource@new_account');
...
//Raffle Module
// Route::get('raffle_history', 'Resource\RaffleController@raffle_history')->name('raffle.history');
// Route::get('search_raffle', 'Resource\RaffleController@raffle_search')->name('raffle.raffle_search');
// Route::post('generate_raffle', 'Resource\RaffleController@generate_raffle')->name('raffle.generate_raffle');
// Route::get('generate_random_raffle', 'Resource\RaffleController@generate_random_raffle')->name('raffle.generate_random_raffle');
// Route::delete('raffle_destroy/{id}', 'Resource\RaffleController@raffle_destroy')->name('raffle.destroy');
// Route::get('raffle_detail/{id}/{user_type}', 'Resource\RaffleController@raffle_detail')->name('raffle.detail');
// Route::post('pay_raffle', 'Resource\RaffleController@pay_raffle')->name('raffle.pay_raffle');
