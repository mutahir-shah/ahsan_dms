...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('drivers', function (Blueprint $table) {
            ...
            $table->decimal('vehicle_monthly_cost', 8, 2)->default(0);
            $table->decimal('mobile_data', 8, 2)->default(0);
            $table->decimal('fuel', 8, 2)->default(0);
            $table->decimal('gprs', 8, 2)->default(0);
            $table->decimal('government_levy_fee', 8, 2)->default(0);
