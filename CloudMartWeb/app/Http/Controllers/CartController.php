...
class CartController extends Controller
{
    public function index(Request $request)
    {
        ...
        if(auth()->user() != null) {
            ...
            $carts = Cart::where('user_id', $user_id)->with('product.stocks')->get();
            
        } else {
            $temp_user_id = $request->session()->get('temp_user_id');
            // $carts = Cart::where('temp_user_id', $temp_user_id)->get();
            $carts = ($temp_user_id != null) ? Cart::where('temp_user_id', $temp_user_id)->with('product.stocks','product.upload')->get() : [] ;
