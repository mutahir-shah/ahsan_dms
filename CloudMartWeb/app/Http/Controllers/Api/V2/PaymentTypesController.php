...
class PaymentTypesController
{
    ...
    public function getList(Request $request)
    {
        ...
        if ($list == "online" || $list == "both") {
            ...
            if (get_setting('moyasar') == 1) {
                $payment_type = array();
                $payment_type['payment_type'] = 'moyasar';
                $payment_type['payment_type_key'] = 'moyasar';
                $payment_type['image'] = static_asset('assets/img/cards/moyasar.png');
                $payment_type['name'] = "Moyasar";
                $payment_type['title'] = "Online Payment";
                $payment_type['offline_payment_id'] = 0;
                $payment_type['details'] = "";
                if ($mode == 'wallet') {
                    $payment_type['title'] = "Recharge with Moyasar";
                }
