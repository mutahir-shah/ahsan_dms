...
class CheckoutController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        if ($request->payment_option != null) {
            ...
            if ($request->session()->get('combined_order_id') != null) {
                ...
                } elseif ($request->payment_option == 'moyasar') {
                    $razorpay = new MoyasarController;
                    return $razorpay->payWithMoyasar($request);
                ...
                } elseif ($request->payment_option == 'moyasar_Pay') {
    ...
    public function store_delivery_info(Request $request)
    {
        ...
        if ($carts && count($carts) > 0) {
            ...
            //echo "<pre>"; print_r($carts); "</pre>";
            //echo "<pre>"; print_r($shipping_info); "</pre>";
            //echo "<pre>"; print_r($total); "</pre>";
            //die();
    ...
    public function moyasarpayment(Request $request)
    {

        $carts = Cart::where('user_id', Auth::user()->id)
            ->get();
        //echo "<pre>"; print_r($carts); echo "</pre>";
        return view('frontend.moyasarpayment', compact('carts'));
    }
    ...
    //return redirect()->route('order_confirmed');
    //  return redirect('frontend.order_confirmed');

    // }



    public function callback(id $id)
    {
    ...
    public function storemosarorder(order $order)
    {
        //$id = requst()->query('id');
        echo "<pre>";
        print_r($order);
