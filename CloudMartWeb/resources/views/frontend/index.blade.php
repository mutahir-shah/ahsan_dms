    ...
    <div class="home-banner-area mb-4 pt-3">
        <div class="container">
            <div class="row gutters-10 position-relative">
                ...
                <div class="@if($num_todays_deal > 0) col-lg-7 @else col-lg-12 @endif">
        ...
        <div class="container">
            <div class="row">
                 @foreach ($featured_categories as $key => $category)
                    <div class="minw-0 col-md-3 col-md mt-3" style="padding-right: 7px; padding-left: 7px;">
                        <a href="{{ route('products.category', $category->slug) }}" class="d-block rounded bg-white p-2 text-reset shadow-sm">
                            <img
                                ...
                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';"
                            >
                            <div class="text-truncate fs-12 fw-600 mt-2 opacity-70" style="text-align: center;"><strong>{{ $category->getTranslation('name') }}</strong></div>
                        </a>
                    </div>
                @endforeach
            </div>
            ...
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('Our Brands') }}</span>
                    </h3>
                </div>

                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="9" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-dots='true' data-autoplay="true">
                    <?php
                        $brands = DB::table('brands')->get();
                    ?>
                    @foreach ($brands as $key => $value)
                        <div class="minw-0 col-md-12 col-md mt-3" style="padding-right: 7px; padding-left: 7px;">
                            <a href="#" class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                <img
                                    src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                    data-src="{{ uploaded_asset($value->logo) }}"
                                    class="lazyload img-fit"
                                    height="80"
                                    onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';"
                                >
           ...
           <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
               <div class="row">
                   <div class="col-sm-4" style="text-align: center;">
                       <div class="col-sm-12  mb-4" style="margin-top: 50px;">
                           <div><i class="la la-support la-3x text-primary"></i></div>
                           <div><strong>Wide variety <br>of products</strong></div>
                       </div>
                       <div class="col-sm-12 mb-4">
                           <div><i class="la la-support la-3x text-primary"></i></div>
                           <div><strong>Easy to use, order <br>within 3 clicks</strong></div>
                       </div>
                       <div class="col-sm-12 mb-4">
                           <div><i class="la la-support la-3x text-primary"></i></div>
                           <div><strong>Re-order easy and fast <br>through your favorites</strong></div>
                       </div>
                   </div>
                   <div class="col-sm-4">
                       <img src="{{ static_asset('assets/img/NBA.png') }}" data-src="{{ static_asset('assets/img/NBA.png') }}" alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload w-100">
                   </div>
                   <div class="col-sm-4" style="text-align: center;">
                       <div class="col-sm-12 mb-4" style="margin-top: 50px;">
                           <div><i class="la la-support la-3x text-primary"></i></div>
                           <div><strong>Delivery in about <br>30 to 60 minutes <br>depending on <br>location</strong></div>
                       </div>
                       <div class="col-sm-12 mb-4">
                           <div><i class="la la-support la-3x text-primary"></i></div>
                           <div><strong>Pay by cash or <br>credit card</strong></div>
                       </div>
                       <div class="col-sm-12 mb-4">
                           <div><i class="la la-support la-3x text-primary"></i></div>
                           <div><strong>Scheduled <br>delivery</strong></div>
                       </div>
                   </div>
               </div>
               <div class="row">
                   <div class="col-sm-12" style="text-align: center;">
                        <p>
                           <strong>Try it out today</strong>
                        </p>
                        <p>
                           <a href="#" class="ml-auto mr-0 btn btn-primary btn-sm shadow-md">Shop Nows</a>
                        </p>
                   </div>
               </div>
           </div>
