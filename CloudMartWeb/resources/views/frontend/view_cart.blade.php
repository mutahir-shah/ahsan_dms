                        ...
                        <div class="mb-4">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                @foreach ($carts as $key => $cartItem)
                                    @php
                                        $product =  $cartItem->product;//\App\Models\Product::find($cartItem['product_id']);
                                       ...
                                       $img = $product->upload->external_link == null ? my_asset($product->upload->file_name) : $product->upload->external_link;
                                    @endphp
                                     <li class="list-group-item px-0 px-lg-3">
                                        <div class="row gutters-5">
                                            <div class="col-lg-5 d-flex">
                                                <span class="mr-2 ml-0">
                                                    <img src="{{ $img }}" class="img-fit size-60px rounded" alt="{{ $product->getTranslation('name')  }}">
                                                </span>
