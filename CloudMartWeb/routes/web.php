...
//demo
Route::get('/demo/welcome', 'DemoController@welcome');
...
Route::group(['prefix' => 'checkout', 'middleware' => ['user']], function() {
	...
	Route::get('/pay_moyasarpayment', 'CheckoutController@moyasarpayment')->name('checkout.moyasarpayment');
	Route::get('/payment/callback', 'CheckoutController@callback')->name('payment.callback');
	Route::get('/moyasarpayment-order', 'CheckoutController@storemosarorder')->name('moyasarpayment.store');
...
Route::get('moyasar/payment/pay-success', 'MoyasarController@payment')->name('payment.moyasar');
