...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    Route::prefix('delivery-boy')->group(function () {
        ...
        Route::post('change-delivery-status', 'Api\V2\DeliveryBoyController@change_delivery_status')->middleware('auth:sanctum');
                //Delivery Boy Order
        Route::get('purchase-history-details/{id}', 'Api\V2\DeliveryBoyController@details')->middleware('auth:sanctum');
        Route::get('purchase-history-items/{id}', 'Api\V2\DeliveryBoyController@items')->middleware('auth:sanctum');
   ...
   Route::get('purchase-history-details/{id}', 'Api\V2\PurchaseHistoryDetailController@index')->name('purchaseHistory.details')->middleware('auth:sanctum');
    ...
    Route::any('moyasar/pay-with-moyasar', 'Api\V2\MoyasarController@payWithMoyasar')->name('api.moyasar.payment');
    Route::any('moyasar/payment', 'Api\V2\MoyasarController@payment')->name('api.moyasar.payment');
    Route::post('moyasar/success', 'Api\V2\MoyasarController@success')->name('api.moyasar.success');
